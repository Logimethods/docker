...
RUN curl -SL http://central.maven.org/maven2/mysql/mysql-connector-java/6.0.6/mysql-connector-java-6.0.6.jar \
  -o ${JBOSS_HOME}/modules/com/mysql/main/mysql-connector-java-6.0.6.jar
